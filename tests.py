...
from bip340_shirt import schnorr_verify


def main():
    for _idx, _secret, pubhex, _aux, msghex, sighex, res_exp in TEST_VECTORS:
        pub = bytes.fromhex(pubhex)
        sig = bytes.fromhex(sighex)
        msg = bytes.fromhex(msghex)
        res_real = schnorr_verify(msg, pub, sig)
        assert res_real == res_exp
        assert isinstance(res_real, bool)

    print("Test vectors pass.")
    return 0


# The following list of test vectors is based on the file
# https://github.com/bitcoin/bips/blob/master/bip-0340/test-vectors.csv .
# authored by Pieter Wuille, Jonas Nick, and Tim Ruffing.
# It is licensed under the BSD-2-Clause license, see
# https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki#copyright .
TEST_VECTORS = [
    (
        "0",
    ...
    # Extra vector for invalid signature length (not present in BIP340's list)
    (
        "19",
        "0340034003400340034003400340034003400340034003400340034003400340",
        "778CAA53B4393AC467774D09497A87224BF9FAB6F6E68B23086497324D6FD117",
        ...
        100 * "99",
        "403B12B0D8555A344175EA7EC746566303321E5DBFA8BE6F091635163ECA79A8"
        + "585ED3E3170807E7C03B720FC54C7B23897FCBA0E9D0B4A06894CFD249F223",
        False,
    ),
]
